...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("chats", "agent-history-central/cursor/session-1.md", ("cursor", "session-1")),
        ("chats", "agent-history-central/pi/session-1.md", ("pi", "session-1")),
        ("chats", "agent-history-central/opencode/session-1.md", ("opencode", "session-1")),
        ("chats", "agent-history-central/openclaw/session-1.md", ("openclaw", "session-1")),
        ("chats", "agent-history-central/unknown/session-1.md", None),
